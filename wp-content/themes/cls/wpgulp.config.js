...
module.exports = {
	...
	// Project options.
	projectURL: 'cls.test', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'cls', // Your textdomain here.
	translationFile: 'cls.pot', // Name of the translation file.
